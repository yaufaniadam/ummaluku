        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @if ($photo)
                    ...
                    <img src="{{ $photo->temporaryUrl() }}" class="img-fluid img-thumbnail mb-3" style="max-width: 200px;">
                @elseif ($student->user->prospective->photo_path)
                    {{-- Tampilkan foto yang sudah ada --}}
                    <img src="{{ Storage::url($student->user->prospective->photo_path) }}"
                        class="img-fluid img-thumbnail mb-3" style="max-width: 200px;">
                @else
                    {{-- Tampilkan placeholder jika tidak ada foto --}}
                    <img src="{{ asset('assets/user.png') }}" class="img-fluid img-thumbnail mb-3" width="100">
                @endif
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="academic_advisor_id">Dosen Wali Akademik</label>
                            <select wire:model="academic_advisor_id" id="academic_advisor_id"
                                class="form-control @error('academic_advisor_id') is-invalid @enderror">
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('admin.akademik.students.index') }}" class="btn btn-secondary">Batal</a>
            </div>
        </div>
    </form>
</div>

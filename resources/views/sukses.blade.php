            ...
            <div class="col-9">
                ...
                <div class="text-center">
                    <div class="mb-3">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="icon icon-tabler icon-tabler-circle-check text-success" width="44" height="44"
                ...
                @if (session('registration_data'))
                    <div class="card card-body my-4">
                        ...
                        <p>Silakan gunakan informasi di bawah ini untuk login ke Portal Pendaftar dan melengkapi dokumen
                            Anda.</p>
                        <dl class="row">
                        ...
                        <div class="alert alert-danger">
                            <strong>PENTING!</strong> Harap catat dan simpan password Anda di tempat yang aman. Password ini
                            hanya
